...
stack "bootstrap" {
  ...
  values = {
    ...
    aws_account_id = "942909611102"

    oidc_resource_prefix = "pipelines"

    github_org_name  = "laureldenmark"
    github_repo_name = "cdmxdemo1"
    deploy_branch = "main"
    ...
    // =========================================================================
    oidc_provider_import_arn = "arn:aws:iam::942909611102:oidc-provider/token.actions.githubusercontent.com"
    plan_iam_role_import_existing = true
    plan_iam_policy_import_arn = "arn:aws:iam::942909611102:policy/pipelines-plan"
    plan_iam_role_policy_attachment_import_arn = "pipelines-plan/arn:aws:iam::942909611102:policy/pipelines-plan"
    apply_iam_role_import_existing = true
    apply_iam_policy_import_arn = "arn:aws:iam::942909611102:policy/pipelines-apply"
    apply_iam_role_policy_attachment_import_arn = "pipelines-apply/arn:aws:iam::942909611102:policy/pipelines-apply"
    // =========================================================================
